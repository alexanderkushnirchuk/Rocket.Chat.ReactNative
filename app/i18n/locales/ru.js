export default {
	...
	Invisible: 'Невидимый',
	Invite: 'Приглашение',
	is_a_valid_RocketChat_instance: 'является действительным сервером UIA.Chat',
	is_not_a_valid_RocketChat_instance: 'не является действительным сервером UIA.Chat',
	is_typing: 'печатает',
	...
	Microphone_Permission_Message: 'UIA Chat нужен доступ к вашему микрофону, чтобы вы могли отправлять аудиосообщения.',
	...
	Not_RC_Server: 'Это не сервер UIA.Chat.\n{{contact}}',
	Nothing: 'Ничего',
	...
	Offline: 'Офлайн',
	Oops: 'Упс!',
	Onboarding_title: 'Добро пожаловать в UIA.Chat',
	Online: 'Онлайн',
    ...
    Privacy_Policy_Sign_Up: ' Политикой Конфиденциальности',
    ...
    Terms_of_Service_Sign_Up: ' Условиями Использования ',
	Theme: 'Тема',
	...
	you: 'вы',
	You: 'Вы',
	You_need_to_access_at_least_one_RocketChat_server_to_share_something: 'Вам нужно получить доступ как минимум к одному серверу UIA.Chat, чтобы поделиться чем-то.',
    ...
    position: 'Должность',
    Get_FinAid: 'Запросить финансовую помощь',
